...
if(isset($_POST['banir'])){
      if(isset($_POST['cod_marca']))  { $atualizar="UPDATE marca set ativo=(0) where cod_marca='".$_POST["cod_marca"]."'";
  //  echo $atualizar;
    $result=mysqli_query($ligax,$atualizar); }
  }
  if(isset($_POST['desbanir'])){
      if(isset($_POST['cod_marca']))  { $atualizar="UPDATE marca set ativo=(1) where cod_marca='".$_POST["cod_marca"]."'";
  //  echo $atualizar;
    $result=mysqli_query($ligax,$atualizar); }
		...
		<div class="banner_inner d-flex align-items-center">
			<div class="container">
				<div class="banner_content text-center">
					...
					<div class="page_link">
						<a href="index.php?pagina=inserirmarcas">Criar marca</a>
...
?>
		...
		margin:10px auto;
		object-fit:cover;
		object-position:50% 50%"src="showfilemarca.php?cod_marca=<?php echo $cod_marca;?>"></div>
									<div class="p_icon">
...
<?php
if(($pag_ant)&&($pag>1)){
echo "<a href='index.php?pagina=listarmarcas&pag=$pag_ant'><<</a>";
}
for ($i=1;$i<=$num_pag;$i++) {
if($i!=$pag) {
echo " <a href='index.php?pagina=listarmarcas&pag=$i'>$i</a>";
} else {
echo " <a href='index.php?pagina=listarmarcas&pag=$i'>$i</a>";
}
}
if ($pag+1<=$num_pag) {
echo " <a href='index.php?pagina=listarmarcas&pag=$pag_seg'>>></a>";
}
?>
