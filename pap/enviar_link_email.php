...
//Envio de mensagem para o email do contacto a confirmar a receção dos dados:
    ...
    $mensagem_1->__set('mensagem' , "Aceda a este link para terminar o seu registo. 
	http://localhost/pap/index.php?pagina=validacao&codigo=$cod;
	Com os melhores cumprimentos, A equipa do projeto");
