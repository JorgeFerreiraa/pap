<?php
		...
		/* Existiu um erro */
		if($flag==true){ 
			if($flag_email==true) echo "Erro no email!!!";
			if($flag_pass==true) echo "Erro na password!!!"; 
	?>
	...
	<?php } else { 
		...
		$insere="INSERT INTO utilizador
			(nome,email,pass) VALUES ('".$nome."','".$email."','".$pass."')";

			$result=mysqli_query($ligax,$insere);
		
			if($result==1){
				
			echo"<p>Parabéns $nome! Realizou o seu registo com sucesso.</p>";
