...
include ('ligacao.php');
   ...
   require "../../PHPMailer/src/SMTP.php";
	...
	// Função Gerar Senha		
	$cod_validacao=gerar_senha(10, true, true, true, true);

	//altera o registo com a nova password
	$sql="UPDATE utilizador SET cod_validacao='".$passcod_validacaoword."' where email='".$email."';";
    ...
    A sua novapassword é:  <b>$cod_validacao</b> ;
	<br>
