...
$cod=$_GET['num'];
$process = " Update encomenda set data_conclusão='".$data."', observacao='".$observacao."', estado=2 where cod_encomenda=$cod;";
...
<?php if($registo['estado']==1){ ?>
<p align='center'><input type='submit' name='processar' value='Concluir'></p>
<?php } ?>
