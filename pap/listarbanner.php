...
if(isset($_POST['banir'])){
      if(isset($_POST['cod_banner']))  { $atualizar="UPDATE banner set ativo=(0) where cod_banner='".$_POST["cod_banner"]."'";
  //  echo $atualizar;
    $result=mysqli_query($ligax,$atualizar); }
  }
  if(isset($_POST['desbanir'])){
      if(isset($_POST['cod_banner']))  { $atualizar="UPDATE banner set ativo=(1) where cod_banner='".$_POST["cod_banner"]."'";
  //  echo $atualizar;
    $result=mysqli_query($ligax,$atualizar); }
  }
      ?>
		...
		<div class="banner_inner d-flex align-items-center">
			<div class="container">
				<div class="banner_content text-center">
					...
					<div class="page_link">
						<a href="index.php?pagina=inserirbanner">Criar banner</a>
...
?>
						<div class="col-lg-3 col-md-3 col-sm-6">
							<div class="f_p_item">
								<div class="f_p_img">
										<div class="img-perfil"><img src="showfilebanner.php?cod_banner=<?php echo $cod_banner;?>"></div>
								</div>
...
<?php
if(($pag_ant)&&($pag>1)){
echo "<a href='index.php?pagina=listarbanner&pag=$pag_ant'><<</a>";
}
for ($i=1;$i<=$num_pag;$i++) {
if($i!=$pag) {
echo " <a href='index.php?pagina=listarbanner&pag=$i'>$i</a>";
} else {
echo " <a href='index.php?pagina=listarbanner&pag=$i'>$i</a>";
}
}
if ($pag+1<=$num_pag) {
echo " <a href='index.php?pagina=listarbanner&pag=$pag_seg'>>></a>";
}
?>
